...
const MyProfile = () => {
  ...
  return (
    <div className="w-11/12 lg:w-4/5 mx-auto border-2 border-[#E3E5E8] rounded-xl shadow-lg p-8 my-12">
      <h3 className="text-3xl font-semibold text-black">My Profile</h3>
      <Divider size="lg" className="my-6" />

      <div className="flex flex-col lg:flex-row gap-3 ">
        <div className="w-full lg:w-1/2 space-y-5 bg-error-60 p-5">
          ...
          <div className="">
            ...
            <p className="border border-[#E3E5E8] bg-[#EFF2F5] py-3 pl-5 rounded-md">
              {user?.displayName}
            </p>
          </div>
          <div>
            <Label>Email</Label>
            <p className="border-2 border-[#E3E5E8] bg-[#EFF2F5] py-3 pl-5 rounded-md">
              {user?.email}
            </p>
          </div>
        </div>
        <div className="w-full lg:w-1/2 border-l-2 border-[#d5d6d8] pl-6">
          <h2 className="text-center text-xl font-medium">Change Profile</h2>
          <div>
